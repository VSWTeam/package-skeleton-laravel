...
vendor_name_unsantized=$(ask_question "Vendor name" "Vswteam")
...
echo
files=$(grep -E -r -l -i ":author|:vendor|:package|Vswteam|skeleton" --exclude-dir=vendor ./*  | grep -v "$script_name")
